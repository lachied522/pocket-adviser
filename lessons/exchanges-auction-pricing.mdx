...
<ImageWithCaption
    alt="World Stock Markets"
    src="/education/Largest-Stock-Markets-in-the-World-1.jpeg"
    caption="Map or the 25 largest stock exchanges in the world"
/>
...
### Brokerage Fees
<KeyConcept content="You will incur a brokerage fee every time you buy and sell a stock." />
...
<KeyConcept content="The bid price is the highest price at which someone is willing to buy a stock, while the **ask price** is the lowest someone is willing to sell it." />
...
<KeyConcept content="For a stock to move up (down), all of the sell (buy) orders above (below) it must be filled." />
...
<KeyConcept content="A limit order executes at the price you specify (or better), while a market order executes at the current bid or ask price." />
