...
<KeyConcept type="Formula" content="Price to Earnings Ratio = Share Price / Annual EPS" />
...
<KeyConcept content="The PE ratio and earnings per share together explain 100% of movements in share price." />
...
<ImageWithCaption
    alt="S&P 500 historical PE Ratio"
    src="/education/sp500-historical-pe-ratio.png"
    caption="S&P 500 historical PE Ratio"
/>
...
<ImageWithCaption
    alt="S&P 500 breakdown by sector"
    src="/education/sp500-sector-breakdown.png"
    caption="S&P 500 PE ratios and other metrics by sector"
/>
...
<KeyConcept type="Formula" content="PEG ratio = PE ratio / EPS growth rate (%)" />
...
<KeyConcept content="High expected growth rates should cause PE ratios to be higher." />
...
<KeyConcept type="Formula" content="Price to Sales Ratio = Share Price / Annual Revenue per Share" />
...
<KeyConcept type="Formula" content="Profit Margin = Net Income / Revenue" />
...
<KeyConcept type="Formula" content="Gross Margin = Gross Profit / Revenue" />
