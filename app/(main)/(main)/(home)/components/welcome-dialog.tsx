            ...
            >
                ...
                <ScrollArea className='max-h-[75vh] sm:max-h-[80vh]'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-3 place-items-center gap-3 px-3 py-6'>
                        <div className='w-full sm:w-auto sm:max-w-max flex flex-row sm:flex-col items-center gap-3.5 md:gap-2 px-2 py-3 border-2 border-zinc-100 rounded-lg select-none'>
