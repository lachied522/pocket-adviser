...
export default function Statistics({ statistics }: StatisticsProps) {
    ...
    const [currentAllocations, proposedAllocations] = useMemo(() => {
        return [
            ...
            .map(([sector, allocation], index) => ({ sector, allocation: 100 * parseFloat(allocation), fill: COLORS[index % COLORS.length] })),
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell className='text-center'>
                                {(100 * statistics.currentPortfolio.dividendYield).toFixed(2)}%
                            </TableCell>
                            <TableCell className='text-center'>
                                {(100 * statistics.proposedPortfolio.dividendYield).toFixed(2)}%
                            </TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
