...
interface AdvancedProps {
    statistics: GetRecommendationsResponse["statistics"]
    stockData: GetRecommendationsResponse["stockData"]
};
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell className='text-center'>
                                {(100 * statistics.currentPortfolio.expectedReturn).toFixed(2)}%
                            </TableCell>
                            <TableCell className='text-center'>
                                {(100 * statistics.proposedPortfolio.expectedReturn).toFixed(2)}%
                            </TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell className='w-[200px]'>
                            ...
                            <TableCell className='text-center'>
                                {statistics.currentPortfolio.standardDeviation.toFixed(2)}
                            </TableCell>
                            <TableCell className='text-center'>
                                {statistics.proposedPortfolio.standardDeviation.toFixed(2)}
                            </TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell className='w-[200px]'>
                            ...
                            <TableCell className='text-center'>
                                {statistics.currentPortfolio.beta.toFixed(2)}
                            </TableCell>
                            <TableCell className='text-center'>
                                {statistics.proposedPortfolio.beta.toFixed(2)}
                            </TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell className='w-[200px]'>
                            ...
                            <TableCell className='text-center'>
                                {statistics.currentPortfolio.sharpeRatio.toFixed(2)}
                            </TableCell>
                            <TableCell className='text-center'>
                                {statistics.proposedPortfolio.sharpeRatio.toFixed(2)}
                            </TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
