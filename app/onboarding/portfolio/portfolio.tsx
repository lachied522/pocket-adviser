...
interface PortfolioProps {
    initialHoldings?: PopulatedHolding[]
}

export default function Portfolio({ initialHoldings }: PortfolioProps) {
    const [populatedHoldings, setPopulatedHoldings] = useState<PopulatedHolding[]>(initialHoldings ?? []);
